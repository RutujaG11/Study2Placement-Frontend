...
function Contact() {
  ...
  const onSubmit = async (data) => {
    const userInfo = {
      access_key: "e743716d-9ec2-400a-b94b-2c5690b7da67",
      name: data.username,
      email: data.email,
            ...
            <div className="w-full md:w-1/2 md:pl-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-center space-x-2">
                  ...
                  <span>+91 7385463573 or +91 9096060964</span>
                </li>
                <li className="flex items-center space-x-2">
                  <FaEnvelope className="text-pink-500" />
                  <span>rutuja.gawali@mitwpu.edu.in or subhojit.mahato@mitwpu.edu.in</span>
                </li>
                <li className="flex items-center space-x-2">
